...
function Scene ({ sheet, guiFadeDefaults = {} }) {
  ...
  return (
    <>
      ...
      {/* <PerspectiveCamera
        ref={cameraRef}
        theatreKey={isOverriding ? undefined : 'Camera'}
        makeDefault
        near={0.1}
        far={5000}
        fov={35}
...
// replace the previous PerspectiveCamera block with this:
{isOverriding ? (
  // while overriding: use a plain R3F camera (not the theatre editable)
  // note: lowercase 'perspectiveCamera' is the r3f primitive
  <perspectiveCamera
    ref={cameraRef}
    makeDefault
    near={0.1}
