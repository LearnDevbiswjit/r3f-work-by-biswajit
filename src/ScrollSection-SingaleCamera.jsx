...
const maybeKey = typeof myKey === 'string' && myKey.length ? myKey : 'Camera'
...
function Scene ({ sheet, project, guiFadeDefaults = {} }) {
      ...
      if (u >= 1) {
        ...
        try {
          ...
          if (shouldSnap) {
            ...
            snapRef.current.duration = (guiFadeDefaults.snapDurationSec || window._springFadeDefaults?.snapDurationSec || 1.2) * 1000
            ...
            // theatre resume will happen after snap end (handled in useFrame)
          } else {
  ...
  return (
    <>
      {/* Single camera instance only (no swapping) */}
      <PerspectiveCamera
        ref={cameraRef}
     theatreKey={maybeKey} 
        makeDefault
